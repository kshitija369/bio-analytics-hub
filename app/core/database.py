...
class SomaticDatabase:
    ...
    def _ensure_initialized(self):
        ...
        print(f"Initializing Somatic Monitor DB Strategy...")
        ...
        if self.working_db != self.persistent_db and os.path.exists(self.persistent_db):
            print(f"Restoring working DB from persistence: {self.persistent_db}")
            try:
        ...
        try:
            ...
            print("Working database ready.")
            self._initialized = True
        except Exception as e:
            print(f"CRITICAL ERROR initializing working DB: {e}")
            raise e
